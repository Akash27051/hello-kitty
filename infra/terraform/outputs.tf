...
output "aws_cloudwatch_log_group_aws_lambda_hello_kitty_function_skyjaiswal2705_arn" {
  value = module.appcd_86ec452a-770a-59bf-87dd-67ed883e25e5.arn
  sensitive = false
}


output "aws_cloudwatch_log_group_aws_lambda_hello_kitty_function_skyjaiswal2705_name" {
  value = module.appcd_86ec452a-770a-59bf-87dd-67ed883e25e5.name
  sensitive = false
}


output "aws_s3_skyjaiswal2705_arn" {
  value = module.appcd_551e1d2b-88ec-5406-87cf-c51521bbe894.arn
  sensitive = false
}


output "aws_s3_skyjaiswal2705_bucket_name" {
  value = module.appcd_551e1d2b-88ec-5406-87cf-c51521bbe894.bucket_name
  sensitive = false
}


output "aws_s3_skyjaiswal2705_bucket_website_endpoint" {
  value = module.appcd_551e1d2b-88ec-5406-87cf-c51521bbe894.bucket_website_endpoint
  sensitive = false
}


output "aws_s3_skyjaiswal2705_kms_arn" {
...
output "aws_lambda_hello_kitty_function_skyjaiswal2705_function_name" {
